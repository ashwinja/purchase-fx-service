...
$SourcesFile = Join-Path $RootDir "build/functional-sources.txt"
...
Get-ChildItem -Path @(
    ...
    (Join-Path $RootDir "src/test/functional/java")
...
java -ea -cp $BuildDir com.example.purchasefx.PurchaseApplicationFunctionalTest
